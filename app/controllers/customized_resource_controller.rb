class CustomizedResourceController < Spree::Api::BaseController
  ...
  def new
    ...
    respond_with(@object) do |format|
      logger.debug "object value is " + @object.inspect
  ...
  def destroy
    ...
    if @object.destroy
      ...
      respond_with(@object) do |format|
        ...
        format.json { render plain: 'deleted successfullly'}
      end
    else
      invoke_callbacks(:destroy, :fails)
      respond_with(@object) do |format|
        format.html { redirect_to location_after_destroy }
        format.json { render plain: 'delete failed'}
      end
    end
  end
  ...
  def resource
    ...
    # logger.debug "controller path is #{controller_path} and controller name is #{controller_name} and parent model is #{parent_model_name} and object name is #{object_name}"
    # @resource = Spree::Admin::Resource.new controller_path, controller_name, parent_model_name, object_name
    @resource = Spree::Admin::Resource.new @path, @name, parent_model_name, object_name
  end
