class LuxireProduct < ActiveRecord::Base
  ...
  validates_presence_of (LuxireProduct.column_names - ["id","created_at","updated_at", "deleted_at", "gift_card_flag"])
  validates_inclusion_of :gift_card_flag, in: [true, false]
end
