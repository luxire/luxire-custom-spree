class LuxireProduct < ActiveRecord::Base
  ...
  validates_presence_of (LuxireProduct.column_names - ["id","created_at","updated_at", "deleted_at", "gift_card_flag"]), :if => lambda { |product_type| product_type.req_validation.eql? true }
