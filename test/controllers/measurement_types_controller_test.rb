...
class MeasurementTypesControllerTest < ActionController::TestCase
  ...
  test "should create measurement_type" do
    assert_difference('MeasurementType.count') do
      post :create, measurement_type: { description: @measurement_type.description, name: @measurement_type.name, value: @measurement_type.value }
    end
  ...
  test "should update measurement_type" do
    patch :update, id: @measurement_type, measurement_type: { description: @measurement_type.description, name: @measurement_type.name, value: @measurement_type.value }
    assert_redirected_to measurement_type_path(assigns(:measurement_type))
  end
