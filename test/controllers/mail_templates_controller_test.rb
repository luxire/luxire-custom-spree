...
class MailTemplatesControllerTest < ActionController::TestCase
  ...
  test "should create mail_template" do
    assert_difference('MailTemplate.count') do
      post :create, mail_template: { content: @mail_template.content, name: @mail_template.name, subject: @mail_template.subject }
    end
  ...
  test "should update mail_template" do
    patch :update, id: @mail_template, mail_template: { content: @mail_template.content, name: @mail_template.name, subject: @mail_template.subject }
    assert_redirected_to mail_template_path(assigns(:mail_template))
  end
